 ...
 * @param <T>
 */
public abstract class GenericDAO<T extends PersistentEntity> implements Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -8746108939876887842L;
	 ...
	 * @param entity
	 */
	public void performValidation(T entity) {
		container.instanceFor(DefaultValidation.class).validate(entity);
	}
