...
public class Solution implements Serializable {
	...
	/**
	 * Gets the distance from the solution to his k-nearest nighbor in a <code>SolutionSet</code>. Returns the value
	 * stored in <code>kDistance_</code>. <b> REQUIRE </b>: this method has to be invoked
	...
	public String toStringResults() {
		String aux = "";
		for (int i = 0; i < this.numberOfObjectives_; i++)
			aux = aux + java.lang.Math.abs(this.getObjective(i)) + "; ";
	 ...
	 *            The <code>DecisionVariables</code> object
