...
public class RadioNetworkDesign extends Problem {
   ...
   */
  public RadioNetworkDesign(int numberOfBits) throws ClassNotFoundException {
    ...
    variableType_[0] = Class.forName("jmetal.base.variable.Binary") ;
  ...
  public void evaluate(Solution individual) {
     Variable[] gen  = individual.getDecisionVariables();
     ...
     for(int i=0; i<((Binary)gen[0]).getNumberOfBits();i++){
